...
async function loadAllData() {
  ...
  // Transformations are here for exactly the same reason as ancestries, and for no other: one is
  // never an option on this screen, but a transformation that moves a slot has to be counted
  // before this screen decides how many are left.
